<div class="modal fade" id="edit-surat-masuk" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-edit-surat-masuk" class="form-horizontal">
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="edit-asal" class="col-sm-4 col-form-label">Asal</label>
                                <div class="col-8">
                                    <input type="text" class="form-control" id="edit-asal" name="edit_asal">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="edit-indeks" class="col-sm-4 col-form-label">Indeks Berkas</label>
                                <div class="col-8">
                                    <textarea class="form-control" id="edit-indeks" name="edit_indeks"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    $(function() {
        $(".edit").on('click', function() {
            $('#edit-no-agenda').val($(this).data('no_agenda'));
            ...
            $('#edit-asal').val($(this).data('asal'));
            $('#edit-indeks').val($(this).data('indeks'));
        ...
        $("#btn-edit").on('click', function() {
            let validate = $("#form-edit-surat-masuk").valid();
            if (validate) {
                $("#form-edit-surat-masuk");
                prosesEditSuratMasuk();
            }
        });

        $("#form-edit-surat-masuk").validate({
            rules: {
                edit_no_agenda: {
                    required: true,
                    digits: true
        ...
        function prosesEditSuratMasuk() {
            let form = $("#form-edit-surat-masuk")[0];
            let data = new FormData(form);
            $.ajax({
                type: "POST",
                enctype: 'multipart/form-data',
                url: "<?= base_url('surat/suratMasuk/prosesEdit') ?>",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
